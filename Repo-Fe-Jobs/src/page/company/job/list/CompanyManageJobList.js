...
export const CompanyManageJobList = () => {
    return (
        <>
            <div className="py-[60px]">
                <div className="container">
                    <div className="flex flex-wrap gap-[20px] items-center justify-between mb-[20px]">
                        ...
                        <Link to="#" className="bg-[#0088FF] rounded-[4px] py-[8px] px-[20px] font-[400] text-[14px] text-white">
                            Thêm mới
                        </Link>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[20px]">
                        ...
                        >
                            ...
                            <div className="flex items-center justify-center gap-[12px] mb-[20px]">
                                <Link to="#" className="bg-[#FFB200] rounded-[4px] font-[400] text-[14px] text-black inline-block py-[8px] px-[20px]">
                                    Sửa
                                </Link>
